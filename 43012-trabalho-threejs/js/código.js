           ...
           ////////////                LETRA P                   //////////////
            ...
            //var points2 = LetraP.getPoints();

            //var geometry1 = new THREE.BufferGeometry().setFromPoints(points2);
            ...
            //var points3 = LetraR.getPoints();

            //var geometry2 = new THREE.BufferGeometry().setFromPoints(points3);
            ...
            //LetraE.lineTo(x+15.5, y + 18.2);
            LetraE.quadraticCurveTo(x+11.5, y + 18.5, x+15, y+19.5);
            LetraE.lineTo(x+16, y+18.5);
            LetraE.lineTo(x+13.5, y+16);       //LetraE.lineTo(x+14.3, y+ 19);
            //LetraE.quadraticCurveTo(x+13, y + 17.5, x+13.7, y+15.9);
            //LetraE.lineTo(x+15, y+12);

            //var points4 = LetraE.getPoints();

            //var geometry3 = new THREE.BufferGeometry().setFromPoints(points4);
            ...
            //var points5 = LetraS.getPoints();

            //var geometry4 = new THREE.BufferGeometry().setFromPoints(points5);
            ...
            //LetraO.quadraticCurveTo(x+33, y+16, x+ 29, y+19);
            //LetraO.quadraticCurveTo(x+ 25, y +19, x+ 29.4, y + 13.5);
            ...
            //var points7 = LetraU.getPoints();

            //var geometry6 = new THREE.BufferGeometry().setFromPoints(points7);
