...
function cabeça(c, parametroscabeca, parametroscabelo, parametrospescoco, parametrosolho, parametrosobrancelha, parametrosboca, parametrospescoco2){
    ...
    /*c.beginPath();
    c.moveTo(parametroscabeca.x, 270);   //inicial x:420, y:270
    c.bezierCurveTo(405, 285, 390, 285, 387, 270);
    c.quadraticCurveTo(385 ,266, 383, 266);
    c.lineTo(388, 260);
    c.bezierCurveTo(390, 255, 388, 250, 390, 250);
    c.quadraticCurveTo(395, 245, 400, 247);
    c.quadraticCurveTo(405, 248, 410, 245);
    c.quadraticCurveTo(406, 250, 412, 260);
    c.quadraticCurveTo(415, 250, 420, 262);
    c.quadraticCurveTo(415, 270, 415, 265);
    c.quadraticCurveTo(414, 275, 420, 270);*/
    ...
    /* c.moveTo(parametroscabelo.x, 250);   //inicial x:390, y:250
    c.quadraticCurveTo(392, 244, 400, 246);
    c.quadraticCurveTo(405, 248, 411, 243);
    c.quadraticCurveTo(407, 250, 412, 260);
    c.quadraticCurveTo(415, 248, 420, 262);
    c.quadraticCurveTo(415, 271, 415, 265);
    c.quadraticCurveTo(416, 274, 425, 274);
    c.quadraticCurveTo(420, 265, 427, 263);
    c.quadraticCurveTo(430, 260, 427, 252);
    c.quadraticCurveTo(437, 245, 424, 241);
    c.quadraticCurveTo(415, 220, 395, 230 );
    c.quadraticCurveTo(390, 238, 385, 228);
    c.quadraticCurveTo(375, 242, 383, 240);
    c.quadraticCurveTo(375, 250, 390, 250);*/
